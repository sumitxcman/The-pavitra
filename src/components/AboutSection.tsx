...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-20 sm:py-24 bg-[#FAF9F6] text-[#111113] relative overflow-hidden border-t border-[#D4AF37]/30">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="mt-2 text-sm sm:text-base text-[#52525B] max-w-lg mx-auto font-sans font-light">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative z-10 rounded-xl overflow-hidden shadow-2xl border-2 border-[#D4AF37] bg-[#FFFFFF] group">
              <img
              ...
              <div className="absolute bottom-4 left-4 right-4 text-[#FFFFFF]">
                <p className="font-serif italic text-sm sm:text-base text-[#FFFFFF] drop-shadow-md">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-5 rounded-xl bg-[#FFFFFF] border border-[#D4AF37]/40 hover:border-[#D4AF37] transition-all duration-300 shadow-md">
