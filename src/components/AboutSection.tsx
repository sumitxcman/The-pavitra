...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-20 sm:py-24 bg-[#0A0A0C] text-[#FFFFFF] relative overflow-hidden border-t border-[#D4AF37]/20">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* Left Column: Entrance Gate & Pink Lounge Photos */}
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-5 rounded-xl bg-[#141417] border border-[#D4AF37]/30 hover:border-[#D4AF37] transition-all duration-300">
              ...
              <div className="p-5 rounded-xl bg-[#141417] border border-[#D4AF37]/30 hover:border-[#D4AF37] transition-all duration-300">
                ...
                <p className="text-xs text-[#F4EFE6]/80 font-light mt-1">No onion & garlic dishes prepared on request.</p>
              </div>
            </div>
